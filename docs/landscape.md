...
| List economics | Standard Firefly Services API consumption under your own Adobe contract — no per-workflow markup | Operations-metered: list **$0.15/Operation**; image workflows consume 75–250 Operations *per output asset* (≈ $11.25–$37.50 list per image); video 15–30 Operations *per output second* (≈ $33.75–$67.50 per 15s). Contracted rates differ; per-org Rate Card is in the Admin Console. [Published rate card](https://helpx.adobe.com/firefly/web/work-with-enterprise-features/creative-production/workflow-builder-rate-card.html) | Credit-metered (free tier ≈ 25 generative credits/mo) |
